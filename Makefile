...
#Zcoin
DEFINES   += BTCHIP_P2PKH_VERSION=82 BTCHIP_P2SH_VERSION=7 BTCHIP_COIN_FAMILY=1 BTCHIP_COINID=\"Zcoin\" COINID_UPCASE=\"ZCOIN\" COLOR_HDR=0x3EAD54 COLOR_DB=0xA3DCAE COINID_NAME=\"Zcoin\" COINID=$(COIN) BTCHIP_COINID_SHORT=\"XZC\" COIN_ZCOIN 
APPNAME ="Zcoin" 
APP_LOAD_PARAMS += --path $(APP_PATH)
else
